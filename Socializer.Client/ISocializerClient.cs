...
public interface ISocializerClient
{
    ...
    Task DeleteMyChatAsync(Guid chatId);
    Task<OperationResult<IEnumerable<UserPreferenceDto>>> GetMyUserPreferencesAsync();
    Task DeleteMyUserPreferenceAsync(Guid preferenceId);
}
